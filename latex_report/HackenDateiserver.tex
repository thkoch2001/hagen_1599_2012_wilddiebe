...
Werkzeug zur Entwicklung und Ausführung von Exploits\footnote{Ein Exploit dient
  dem Eindringen in ein Zielsystem, indem ein Programmfehler ausgenutzt wird.} gegen verteilte
Zielrechner. Andere wichtige Teilprojekte sind das Shellcode-Archiv\footnote{Payload (Nutzlast) bezeichnet den Code, der auf dem
