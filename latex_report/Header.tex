...
\lstnewenvironment{RezeptCode}[2]
...
%\newcaptionname{german}{\lstlistingname}{Code-Beispiel}
%\renewcommand{\lstlistingname}{Code-Beispiel}
...
\newcommand{\Zenmap}{\emph{Zenmap}}
\newcommand{\Nmap}{\emph{Nmap}}
\newcommand{\zB}{z.\,B.}
\newcommand{\va}{v.\,a.}
\newcommand{\dH}{d.\,h.}
...
\hyphenation{Hand-shakes}
\hyphenation{Open-VPN}
\hyphenation{Wild-diebe}
\hyphenation{Zer-ti-fi-kat}
